...
1.  Generate a Morishita Plot for the Swedish Pines data using
    ```{r}
    miplot(swedishpines)
    ```

2.  Generate Fry Plots for the Swedish Pines data using the two commands
    ```{r}
    fryplot(swedishpines)
    fryplot(swedishpines, width=50)
    ```

3.  What can you interpret from these plots?
